...
import RuangSelaIcon from "@/assets/RuangSelaIcon.svg";
  ...
  return (
    <div className="w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center mb-10">
        <Link
          href="/"
          className="inline-flex items-center justify-center p-3 bg-sage-50 rounded-full text-sage-600 hover:bg-sage-100 hover:text-sage-900 transition-colors mb-8 group"
        >
      ...
      <form className="space-y-6" action={onSubmit}>
        ...
        <div className="space-y-5">
          <div>
            <label className="text-sm font-semibold text-sage-900 block mb-2">
              Email Pengguna
            </label>
            <Input
              name="email"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm font-semibold text-sage-900 block">
                Kata Sandi
              </label>
              <Link
                href="#"
                className="text-xs font-bold text-softBlue-600 hover:text-softBlue-700 transition-colors"
              >
                Lupa Kata Sandi?
              </Link>
            </div>
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full h-14 mt-4 bg-softBlue-500 hover:bg-softBlue-600 text-white font-bold text-lg rounded-xl shadow-lg shadow-softBlue-900/20 transition-all hover:-translate-y-1 hover:shadow-xl"
        >
          ...
          <div className="bg-softBlue-50 rounded-2xl p-5 border border-softBlue-200">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                size="sm"
                variant="outline"
                className="w-full border-softBlue-300 text-softBlue-800 bg-white hover:bg-softBlue-100 h-10 font-semibold transition-colors"
              ...
              <Button
                ...
                size="sm"
                variant="outline"
                className="w-full border-rose-300 text-rose-800 bg-white hover:bg-rose-50 h-10 font-semibold transition-colors"
                onClick={() => fillDemo("risk")}
              >
      ...
      <p className="text-center text-sm font-medium text-sage-600 mt-10">
        ...
        <Link
          href="/register"
          className="font-bold text-sage-900 hover:text-softBlue-600 transition-colors"
        >
          Daftar di sini
        </Link>
      </p>
  ...
  return (
    <div className="min-h-screen bg-white flex w-full font-sans overflow-hidden">
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-12 xl:px-24">
        <Suspense
          fallback={
            <div className="p-8 text-center text-sage-500 font-medium">
              Memuat form keamanan...
            </div>
          }
        >
          <LoginForm />
      ...
      <div className="hidden lg:flex w-1/2 relative bg-sage-50 items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-lg p-10 text-white mt-auto mb-20 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
          ...
          <p className="text-lg text-sage-100 font-medium leading-relaxed">
            Lebih dari sekadar mengejar target kelulusan. RuangSela hadir untuk
            merawat kewarasanmu di setiap sela perjuangan akademik.
          </p>
        </div>
      </div>
    </div>
