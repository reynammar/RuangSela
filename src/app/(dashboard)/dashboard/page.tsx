...
export default async function DashboardPage() {
  ...
  if (user) {
    ...
    if (journals && journals.length > 0) {
      // Data latestJournal tersedia jika ingin dikembangkan nanti
      // console.log("Latest journal id:", journals[0].id)
    }
  }
  ...
  return (
    <div className="w-full flex flex-col pb-16 animate-in fade-in duration-500">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 xl:px-12 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
          <div className="max-w-xl animate-in slide-in-from-bottom-8 duration-700">
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white leading-[1.2] mb-6 drop-shadow-md">
              {greeting},<br />
              <span className="text-softBlue-400">Waktunya Beri Jeda.</span>
            </h1>

            <p className="text-[15px] md:text-[18px] text-sage-100 font-medium leading-relaxed max-w-lg mb-10 drop-shadow mx-auto md:mx-0">
              Kesehatan mentalmu adalah landasan dari segala pencapaian
              akademis. Hubungkan kembali emosimu, pantau kondisi stres, dan
              temukan ketenangan.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
              <Link
                href="/onboarding"
                className="w-full sm:w-auto flex items-center justify-center h-14 px-8 rounded-full bg-softBlue-500 text-white font-bold hover:bg-softBlue-600 transition-transform shadow-xl shadow-softBlue-900/20 hover:-translate-y-1"
              >
              ...
              <Link
                href="/journal"
                className="w-full sm:w-auto flex items-center justify-center h-14 px-8 rounded-full border-2 border-white/30 text-white bg-white/10 font-bold hover:bg-white/20 backdrop-blur-sm transition-all shadow-xl"
              >
          ...
          {hasData && assessmentResult ? (
            <div className="w-full md:w-[340px] bg-white/10 backdrop-blur-xl border border-white/20 rounded-[28px] p-6 sm:p-8 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 text-left">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[11px] font-bold text-sage-100 uppercase tracking-widest">
                    Status Terkini
                  </span>
                </div>
                ...
                <p className="text-[14px] text-sage-100 font-medium mb-4">
                  Risiko Burnout:{" "}
                  <span className="text-white font-bold bg-white/10 px-2 py-0.5 rounded ml-1">
                    {assessmentResult.burnoutRisk}
                  </span>
                </p>
            ...
            <div className="w-full md:w-[340px] bg-white/5 border border-white/10 border-dashed rounded-[28px] p-8 flex flex-col items-center justify-center text-center backdrop-blur-sm mx-auto md:mx-0">
              ...
              <p className="text-[14px] text-white/60 font-medium leading-relaxed">
                Peta emosional belum tersedia. Mulai dengan asesmen stres hari
                ini.
              </p>
            </div>
          )}
        ...
        <div className="relative bg-gradient-to-br from-sage-50 via-white to-sage-50/50 rounded-3xl p-6 sm:p-10 border border-sage-200/60 shadow-sm overflow-hidden flex flex-col md:flex-row items-center gap-6 sm:gap-10 justify-between group cursor-default">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg sm:text-2xl font-serif text-slate-800 leading-relaxed max-w-3xl italic">
              &quot;Tidak apa-apa untuk menjeda langkahmu sejenak. Kamu tidak
              sedang tertinggal, kamu sedang mensinkronkan ulang dirimu.&quot;
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto w-full px-6 sm:px-8 xl:px-12 pt-16 pb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-[15px] font-medium text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Tiga pilar utama yang dirancang untuk membantu kamu menjaga
            keseimbangan mental di tengah padatnya dunia perkuliahan.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          <div className="bg-white rounded-[24px] p-8 border border-slate-200/60 shadow-sm hover:border-softBlue-300 hover:shadow-xl transition-all duration-300 group flex flex-col h-full text-center items-center">
            ...
            <h3 className="text-[18px] font-bold text-slate-900 mb-3 tracking-tight">
              Cek Peta Emosional
            </h3>
            <p className="text-[14px] text-slate-500 font-medium leading-relaxed mb-8 flex-1">
              Pantau kondisi mentalmu lewat skor mingguan biar tahu kapan harus
              istirahat sejenak. Jangan biarkan tugas menumpuk jadi beban.
            </p>
            <Link
              href="/onboarding"
              className="inline-flex items-center text-[11px] font-bold text-softBlue-600 hover:text-softBlue-700 transition-colors uppercase tracking-widest"
            >
          ...
          <div className="bg-white rounded-[24px] p-8 border border-slate-200/60 shadow-sm hover:border-softBlue-300 hover:shadow-xl transition-all duration-300 group flex flex-col h-full text-center items-center">
            ...
            <p className="text-[14px] text-slate-500 font-medium leading-relaxed mb-8 flex-1">
              ...
              tanpa nge-judge, bantu kamu lebih tenang dan temukan solusi nyata
              dari kegundahanmu.
            </p>
            <Link
              href="/journal"
          ...
          <div className="bg-white rounded-[24px] p-8 border border-slate-200/60 shadow-sm hover:border-rose-300 hover:shadow-xl transition-all duration-300 group flex flex-col h-full text-center items-center">
            ...
            <p className="text-[14px] text-slate-500 font-medium leading-relaxed mb-8 flex-1">
              Nggak perlu merasa sendirian di keramaian kampus. Simpan kontak
              sobat atau akses cepat rujukan konselor saat segalanya terasa di
              luar kendali.
            </p>
            <Link
              href="/help"
              className="inline-flex items-center text-[11px] font-bold text-rose-600 hover:text-rose-700 transition-colors uppercase tracking-widest"
            >
      ...
      {/* 4. Gamification & Tips Split Section */}
          ...
          <div className="lg:col-span-7 bg-white rounded-[28px] p-6 sm:p-8 border border-slate-200/60 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-slate-50/50 rounded-2xl p-5 border border-slate-100 flex flex-col">
                ...
                <p className="text-[11px] font-bold text-emerald-600 mt-auto">
                  +1 hari ini
                </p>
              </div>
          ...
          <div className="lg:col-span-5 bg-sage-900 rounded-[28px] p-8 lg:p-10 relative overflow-hidden group shadow-[0_8px_30px_rgba(15,23,42,0.1)]">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="mt-auto">
                <h4 className="text-xl font-bold text-softBlue-400 mb-3 tracking-tight">
                  Teknik Grounding 5-4-3-2-1
                </h4>
                <p className="text-[14px] sm:text-[15px] font-medium leading-relaxed text-sage-100/90 mb-6">
                  Lakukan jeda sebentar. Sebutkan 5 benda yang bisa kamu lihat,
                  4 yang bisa disentuh, dan 3 yang bisa didengar untuk membawa
                  fokusmu kembali ke saat ini.
                </p>
