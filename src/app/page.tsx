...
import RuangSelaLogo2 from "@/assets/RuangSelaLogo2.svg";

// Custom SVG Icon untuk Instagram (karena dihapus dari Lucide)
    ...
    <div className="min-h-screen bg-sage-50/20 flex flex-col font-sans overflow-x-hidden">
      <header className="px-4 sm:px-8 xl:px-12 h-20 flex items-center justify-between bg-white border-b border-sage-100 sticky top-0 z-50 shadow-sm">
        ...
        <nav className="hidden lg:flex gap-10 text-[15px] font-bold text-sage-700">
          <a
            href="#beranda"
            className="hover:text-softBlue-500 transition-colors border-b-2 border-transparent hover:border-softBlue-500 pb-1"
          >
            Beranda
          </a>
          <a
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="hidden sm:block">
            <Button
              variant="ghost"
              className="text-sage-800 font-bold hover:text-sage-950 hover:bg-sage-100 px-6"
            >
              Masuk
            </Button>
          </Link>
      ...
      <main className="flex-1">
        <section
          id="beranda"
          className="relative w-full min-h-[600px] lg:h-[750px] flex items-center overflow-hidden"
        >
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 xl:px-12 pt-10">
            <div className="max-w-3xl animate-in slide-in-from-bottom-8 duration-700">
              ...
              <p className="text-lg sm:text-xl text-sage-100 font-medium leading-relaxed max-w-2xl mb-10 drop-shadow">
                RuangSela membantu mahasiswa mengelola beban akademik
                tersembunyi secara profesional. Jangan simpan stresmu sendirian,
                kelola bersama ekosistem dan asisten peduli kami.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/register">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-softBlue-500 hover:bg-softBlue-600 text-white shadow-xl shadow-softBlue-900/20 text-lg h-14 px-8 rounded-full font-bold transition-transform hover:-translate-y-1"
                  >
                ...
                <Link href="/login?demo=true">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto border-white/30 text-white bg-white/10 hover:bg-white/20 backdrop-blur-sm shadow-xl text-lg h-14 px-8 rounded-full font-bold transition-all border-2"
                  >
                    Coba Demo Juri
                  </Button>
                </Link>
        ...
        <section
          id="fitur"
          className="pt-20 pb-16 px-6 sm:px-8 max-w-7xl mx-auto"
        >
          <div className="text-center mb-16 animate-in fade-in duration-700 delay-300">
            ...
            <p className="text-lg text-sage-600 font-medium max-w-2xl mx-auto">
              RuangSela adalah ekosistem terpadu yang memberikan alat preventif
              dan reaktif untuk merawat kesehatan mental mahasiswa.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-20">
            <div className="bg-white border-2 border-sage-100 rounded-[2rem] p-8 hover:border-softBlue-300/50 hover:shadow-2xl hover:shadow-softBlue-100 transition-all duration-300 group flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-extrabold text-sage-900 mb-3">
                Radar Stres Akademik
              </h3>
              <p className="text-sage-600 text-[15px] font-medium leading-relaxed">
                Kelola beban SKS dan tugasmu biar nggak gampang burnout. Pantau
                kondisi mentalmu lewat skor mingguan biar tahu kapan harus
                istirahat sejenak.
              </p>
            </div>
            ...
            <div className="bg-white border-2 border-sage-100 rounded-[2rem] p-8 hover:border-softBlue-300/50 hover:shadow-2xl hover:shadow-softBlue-100 transition-all duration-300 group flex flex-col items-center text-center mt-0 lg:mt-8">
              ...
              <p className="text-sage-600 text-[15px] font-medium leading-relaxed">
                Tumpahkan perasaanmu di sini. AI kita siap jadi pendengar setia
                tanpa nge-judge, bantu kamu lebih tenang dan temukan solusi
                nyata dari kegundahanmu.
              </p>
            </div>
            ...
            <div className="bg-white border-2 border-sage-100 rounded-[2rem] p-8 hover:border-emerald-300/50 hover:shadow-2xl hover:shadow-emerald-100 transition-all duration-300 group flex flex-col items-center text-center">
              ...
              <p className="text-sage-600 text-[15px] font-medium leading-relaxed">
                Kadang kita butuh bantuan tapi segan untuk cerita. Biar sistem
                kami yang mengabari teman terpercayamu saat beban stresmu butuh
                perhatian lebih.
              </p>
            </div>
            ...
            <div className="bg-white border-2 border-sage-100 rounded-[2rem] p-8 hover:border-rose-300/50 hover:shadow-2xl hover:shadow-rose-100 transition-all duration-300 group flex flex-col items-center text-center mt-0 lg:mt-8">
              ...
              <p className="text-sage-600 text-[15px] font-medium leading-relaxed">
                Nggak perlu merasa sendirian di keramaian kampus. Akses cepat
                ruujukan konselor atau layanan krisis saat segalanya terasa di
                luar kendali.
              </p>
            </div>
          </div>
        ...
        <section
          id="carakerja"
          className="py-24 bg-white border-y border-sage-100"
        >
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-extrabold text-sage-950 tracking-tight mb-4">
                Cara Kerja RuangSela
              </h2>
              <p className="text-lg text-sage-600 font-medium">
                Langkah mudah untuk mulai mengelola keseimbangan akademismu.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              {[
                ...
                <div
                  key={idx}
                  className="relative z-10 bg-white border-2 border-softBlue-100 rounded-[2rem] p-8 shadow-sm hover:shadow-xl hover:border-softBlue-300 transition-all duration-300"
                >
                  <div className="absolute -top-6 -right-2 text-[80px] font-black text-softBlue-500/10 leading-none select-none">
                    {item.step}
                  </div>
                  <h3 className="text-xl font-extrabold text-softBlue-600 mb-4">
                    {item.title}
                  </h3>
            ...
            <div className="mt-16 bg-sage-50/50 border border-sage-200 rounded-3xl p-8 max-w-4xl mx-auto flex flex-col md:flex-row gap-8 items-center justify-between">
              <div className="flex-1">
                <h3 className="text-xl font-extrabold text-sage-900 mb-3">
                  Keamanan & Layanan Terpercaya
                </h3>
                <p className="text-sm text-sage-600 font-medium leading-relaxed">
                  Data obrolan dan hasil analisismu adalah milikmu. Kami tidak
                  menjual data kesehatan mental kepada pihak ketiga, dan semua
                  profil disamarkan untuk anonimitas maksimal.
                </p>
              </div>
              <div className="flex-1 space-y-4">
                <div className="flex gap-3 items-center">
                  ...
                  <span className="text-sm font-bold text-sage-900">
                    Privasi Anonim & Enkripsi AES-256
                  </span>
                </div>
                <div className="flex gap-3 items-center">
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 flex-shrink-0" />
                  <span className="text-sm font-bold text-sage-900">
                    Kurasi Bantuan Profesional
                  </span>
                </div>
                <div className="flex gap-3 items-center">
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 flex-shrink-0" />
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                Dampak Nyata & Dukungan Riil
              </h2>
              <p className="text-softBlue-100 font-medium mt-3">
                Karena setiap mahasiswa berharga.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x-0 md:divide-x divide-softBlue-400">
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-bold uppercase tracking-widest text-softBlue-100">
                  User Terbantu
                </div>
              </div>
              <div className="flex flex-col items-center">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="flex flex-col md:flex-row gap-12 items-start">
              <div className="w-full md:w-1/3">
                <h2 className="text-3xl font-extrabold text-sage-950 mb-4">
                  Pertanyaan Umum
                </h2>
                <p className="text-sage-600 font-medium mb-6">
                  Semua hal yang perlu kamu ketahui tentang privasi dan cara
                  menggunakan RuangSela.
                </p>
                <div className="p-6 bg-white border border-softBlue-200 rounded-2xl flex flex-col items-start gap-4 shadow-sm">
                  ...
                  <Button
                    variant="outline"
                    className="border-softBlue-500 text-softBlue-600 hover:bg-softBlue-50 rounded-full font-bold"
                  >
                    Hubungi Bantuan
                  </Button>
                </div>
              ...
              <div className="w-full md:w-2/3 space-y-4">
                {[
                  {
                    q: "Apakah hasil jurnal saya dibaca oleh orang lain?",
                    a: "Tidak. Jurnal ditangani murni oleh algoritma enkripsi secara otomatis. Tak ada pihak internal kami yang membaca secara manual.",
                  },
                  {
                    q: "Bagaimana cara kerja fitur Trusted Buddy?",
                    a: "Jika skor stresmu melebihi batas bahaya selama 2 minggu berturut-turut, sistem akan mengirim email pengingat otomatis ke email sobat yang sudah kamu daftarkan (jika diaktifkan).",
                  },
                  {
                    q: "Apakah AI ini bisa memberikan resep obat penenang?",
                    a: "Sangat tidak. AI ini difungsikan sebagai teman diskusi ringan dan pemetaan awal. Untuk indikasi klinis, konsultasi manusia adalah kewajiban.",
                  },
                  {
                    q: "Apakah aplikasi ini berbayar untuk fitur dasar?",
                    a: "Aplikasi ini (MVP stage) disediakan 100% gratis untuk mahasiswa yang memakai email `.ac.id`.",
                  },
                ].map((faq, i) => (
                  <div
                    key={i}
                    className="bg-white border border-sage-200 rounded-2xl p-6 group hover:border-softBlue-400 transition-colors shadow-sm cursor-pointer"
                  >
      ...
      <footer className="bg-softBlue-600 pt-16 pb-8 border-t border-softBlue-500">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium text-softBlue-100">
                ...
                <li className="flex gap-3 items-center">
                  <Phone className="w-4 h-4 text-white" /> Bantuan Darurat: 119
                </li>
                <li className="flex gap-3 items-center">
